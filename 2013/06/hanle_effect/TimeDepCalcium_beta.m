function [ occupation_E1, occupation_E2, occupation_E3] = ...
    TimeDepCalcium_beta( alphaUV, betaUV, alphaIR, betaIR, Bx, By, Bz, DeltaB, Omega1, Omega3, Delta1, Delta3, ... 
...
L =  L0 + (norm(B) + DeltaB * fn('cexp',1i*omega)) * LB  + (norm(B) + DeltaB * fn('cexp',-1i*omega)) * LBd  + ...
